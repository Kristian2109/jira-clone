...
class ProjectController {
  ...
  public async createProject(req: AuthenticatedRequest, res: Response) {
    ...
    const project = await this._projectManager.createProject(
      projectToCreate,
      req.user.id
    );
  ...
  public async addBoardColumn(req: AuthenticatedRequest, res: Response) {
    ...
    const projectId = Number(req.params.projectId);
    await this._boardManager.addBoardColumn({
      columnDTO: columnToAdd,
      projectId,
    });
    return res.sendStatus(201);
  }
  ...
  public async deleteBoardColumn(req: AuthenticatedRequest, res: Response) {
    ...
    const projectId = Number(req.params.projectId);
    await this._boardManager.deleteBoardColumn({
      columnId: columnToDeleteId,
      projectId,
    });
  ...
  public async addIssueToBoard(req: AuthenticatedRequest, res: Response) {
    ...
    const issue = await this._issueManager.addIssueToBoard({
      projectId,
      boardColumnId,
      issueId,
    });
  ...
  public async createIssueType(req: AuthenticatedRequest, res: Response) {
    ...
    const newIssueType = await this._issueManager.createIssueType(
      projectId,
      issueDetails
    );
    return res.status(201).json({
  ...
  public async getIssueType(req: AuthenticatedRequest, res: Response) {
    ...
    const issueType = await this._issueManager.findIssueType(
      projectId,
      issueTypeId
    );
  ...
  public async addIssueField(req: AuthenticatedRequest, res: Response) {
    ...
    const updatedIssueType = await this._issueManager.createIssueField({
      projectId,
      issueTypeId,
      issueField: fieldToCreate,
    });
  ...
  public async createIssue(req: AuthenticatedRequest, res: Response) {
    ...
    const createdIssue = await this._issueManager.createIssue({
      projectId,
  ...
  public async updateIssue(req: AuthenticatedRequest, res: Response) {
    ...
    const updatedIssue = await this._issueManager.updateIssueField({
      projectId,
      issueId,
      updateInfo,
    });
